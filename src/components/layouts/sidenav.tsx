...
export default function SideNav() {
  ...
  return (
    <div className='flex h-max md:h-full flex-col px-3 py-2 md:px-2'>
      <Link
        className='mb-2 flex items-center justify-center md:justify-start rounded-md bg-primary px-6 p-4 md:h-20 backdrop-blur-md'
        href='/'
      >
        <div className='text-white flex gap-4'>
          <Image src='/images/logo-filled.svg' alt='SIMA Logo' width={24} height={24} />
