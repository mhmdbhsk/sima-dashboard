...
type DialogDetailSkripsiProps = {
  trigger: React.ReactNode
  data: SkripsiListReponseDatumDto
}

export default function DialogDetailSkripsi({ trigger, data }: DialogDetailSkripsiProps) {
  ...
  return (
    <Dialog onOpenChange={setState} open={state}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Detail Laporan Skripsi</DialogTitle>
        </DialogHeader>
        <DialogDescription>
          <div className='space-y-3 w-full'>
            ...
            <div className='flex justify-between items-center space-y-1'>
              ...
              <Button
                ...
                onClick={() =>
                  handleDownload(
                    `${process.env.NEXT_PUBLIC_BASE_URL}/uploads/skripsi/${data.fileSkripsi}`,
                    data.fileSkripsi
                  )
                }
              >
